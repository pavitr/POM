...
public class TestBase {
	...
	public static Properties prop;// Global varibale so can be used anywhere
...
public TestBase()
{
	...
	{
	prop=new Properties();
	FileInputStream ip=new FileInputStream("C:/Users/pavthrc/Documents/selenium/FreeCRMTest/src/main/java/com/crm/qa/config/config.properties");
	prop.load(ip);
	}
